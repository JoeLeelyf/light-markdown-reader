...
1. **`index.html`** — The entire frontend in one file (~2000 lines). Contains all HTML structure, CSS (6 themes via CSS custom properties), and vanilla JS (~900 lines). External libraries loaded via CDN: marked.js (v12.0.1), highlight.js (v11.9.0), KaTeX (v0.16.9), Papa Parse (v5, CSV/TSV parsing), hyparquet (dynamic import, Parquet parsing).
